    ...
    Activity 1:  Add your APIXU API KEY in the code below.  This KEY can be retreived by visiting the 
                 ...
                 (https://www.apixu.com)
                  ...
                  Use the following code as an example:  
                     ...
                     url: 'https://api.apixu.com/v1/forecast.json?key=e59390e8b46588da59926a713933709f'
...
/******************************************************INSERT YOUR CODE BELOW!!!***********************************************/
        ...
        $(document).ready(function(){
           $(':button').click(function(){
                ...
                $.ajax({
                      type: 'GET',
                      url: 'https://api.apixu.com/v1/forecast.json?key=d5f83a59a5474c5e9b882147181704',
                      data: message             
                })
                .done(function(json){
